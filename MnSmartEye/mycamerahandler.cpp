...
//                  << std::endl;
  ...
  /*  processFrame(rawFrame->frameId, (char*)rawFrame + sizeof(RawImageFrame),
    ...
    processFrame(rawFrame->frameId, (char*)rawFrame + sizeof(RawImageFrame),
        (char*)rawFrame + rawFrame->dataSize + sizeof(RawImageFrame), rawFrame->time,
...
void MyCameraHandler::processFrame(int frameId, char* image, char* extended,
    int64_t time, int width, int height)
{
    ...
    case FrameId::LaneExt:
    {
        ...
        LdwDataPack* ldwDataPack = (LdwDataPack*)extended;
        std::cout << "left_Lane_width: " << ldwDataPack->roadway.left_Lane.width <<
            std::endl;
        std::cout << "rightLane_width: " << ldwDataPack->roadway.rightLane.width
            << std::endl;
        std::cout << "steerStatus : " << ldwDataPack->steerStatus << std::endl;
        std::cout << "left_Lane style : " << ldwDataPack->roadway.left_Lane.style <<
            std::endl;
        std::cout << "rightLane style : " << ldwDataPack->roadway.rightLane.style <<
            std::endl;
        std::cout << "Left_Lane left_Boundary degree: " <<
            ldwDataPack->roadway.left_Lane.left_Boundary.degree << std::endl;
        std::cout << "Left_Lane_Left_Boundray_C0: " <<
            ldwDataPack->roadway.left_Lane.left_Boundary.coefficient[0] << std::endl;
        std::cout << "Left_Lane_Left_Boundray_C1: " <<
            ldwDataPack->roadway.left_Lane.left_Boundary.coefficient[1] << std::endl;
        std::cout << "Left_Lane_Left_Boundray_C2: " <<
            ldwDataPack->roadway.left_Lane.left_Boundary.coefficient[2] << std::endl;
        std::cout << "Left_Lane_Left_Boundray_C3: " <<
            ldwDataPack->roadway.left_Lane.left_Boundary.coefficient[3] << std::endl;
        std::cout << "Left_Lane right_Boundary degree: " <<
            ldwDataPack->roadway.left_Lane.rightBoundary.degree << std::endl;
        std::cout << "Left_Lane_right_Boundray_C0: " <<
            ldwDataPack->roadway.left_Lane.rightBoundary.coefficient[0] << std::endl;
        std::cout << "Left_Lane_right_Boundray_C1: " << ldwDataPack->roadway.left_Lane.rightBoundary.coefficient[1] << std::endl;
        std::cout << "Left_Lane_right_Boundray_C2: " <<
            ldwDataPack->roadway.left_Lane.rightBoundary.coefficient[2] << std::endl;
        std::cout << "Left_Lane_right_Boundray_C3: " <<
            ldwDataPack->roadway.left_Lane.rightBoundary.coefficient[3] << std::endl;
        std::cout << "right_Lane left_Boundary degree: " <<
            ldwDataPack->roadway.rightLane.left_Boundary.degree << std::endl;
        std::cout << "right_Lane_left_Boundray_C0: " <<
            ldwDataPack->roadway.rightLane.left_Boundary.coefficient[0] << std::endl;
        std::cout << "right_Lane_left_Boundray_C1: " <<
            ldwDataPack->roadway.rightLane.left_Boundary.coefficient[1] << std::endl;
        std::cout << "right_Lane_left_Boundray_C2: " <<
            ldwDataPack->roadway.rightLane.left_Boundary.coefficient[2] << std::endl;
        std::cout << "right_Lane_left_Boundray_C3: " <<
            ldwDataPack->roadway.rightLane.left_Boundary.coefficient[3] << std::endl;
        std::cout << "right_Lane right_Boundary degree: " <<
            ldwDataPack->roadway.rightLane.rightBoundary.degree << std::endl;
        std::cout << "right_Lane_right_Boundray_C0: " <<
            ldwDataPack->roadway.rightLane.rightBoundary.coefficient[0] << std::endl;
        std::cout << "right_Lane_right_Boundray_C1: " <<
            ldwDataPack->roadway.rightLane.rightBoundary.coefficient[1] << std::endl;
        std::cout << "right_Lane_right_Boundray_C2: " <<
            ldwDataPack->roadway.rightLane.rightBoundary.coefficient[2] << std::endl;
        std::cout << "right_Lane_right_Boundray_C3: " <<
            ldwDataPack->roadway.rightLane.rightBoundary.coefficient[3] << std::endl;
        ...
        RoadwayPainter::paintRoadway(extended, rgbBuf, width,
            height);
    }
    break;
    default:
